...
class _AddIngredientDialogState extends State<AddIngredientDialog> {
  ...
  List<int> _getDaysInMonth(int year, int month) {
    return List<int>.generate(
        DateUtils.getDaysInMonth(year, month), (i) => i + 1);
  }
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      filteredIngredients = ingredientViewModel.allIngredients
                          .where((ingredient) =>
                      ingredient['food_category'] == value)
                          .toList();
                    });
                  },
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Theme
                        .of(context)
                        .primaryColor),
                    prefixIcon: Icon(Icons.fastfood, color: Theme
                        .of(context)
                        .primaryColor),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      ingredient['food_category'] == selectedCategory &&
                          ingredient['food_name'].toLowerCase().contains(
                              value.toLowerCase()))
                          .toList();
                    });
                  },
                  ...
                  Container(
                    ...
                    child: filteredIngredients.isNotEmpty
                      ...
                      itemBuilder: (context, index) {
                        ...
                        : Center(
                        child: Text('No ingredients found')), // 빈 상태일 때 표시할 내용
                  ),
                SizedBox(height: 16.0),
                Row(
                  children: [
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton.icon(
                      ...
                      icon: Icon(Icons.cancel, color: Theme
                          .of(context)
                          .primaryColor),
                      label: Text(
                        '취소',
                      ...
                      onPressed: () async {
                        if (selectedFoodId != null &&
                          ...
                          final expirationDate =
                              ...
                              .padLeft(2, '0')}-${selectedDay!.toString()
                              .padLeft(2, '0')}';
                          bool success = await ingredientViewModel
                              .addIngredient(
